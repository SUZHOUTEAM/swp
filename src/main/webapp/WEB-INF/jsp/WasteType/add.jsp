...
<section>
    <div class="el-breadcrumb">
        ...
        <span class="el-breadcrumb__item">
            <span class="el-breadcrumb__item__inner">危废类别新增</span>
            <span class="el-breadcrumb__separator">/</span>
        </span>
    </div>
    <div>
        <div class="row">
            <div class="col-md-12">
               <div class="panel panel-default">
                    <div class="panel-heading">危废类别新增页面</div>
                    <div class="panel-body">
                        <form:form class="form-horizontal" modelAttribute="wasteType" id="editForm" data-parsley-validate="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group" id="divHW">
                                        ...
                                        <form:input type="text" path="code" placeholder="输入废物类别代码，2位以内的数字" class="form-control"  maxlength="2" 
...
function sub(that,model){
    if (validate ()) {
        ...
        $.page.ajax($.page.getAjaxSettings({
            ...
            type: "POST",
            dataType: "json",
            url: "/WasteType/saveWasteType.htm",
            data: $('form').serialize(),
            success: function (result, textStatus, jqXHR) {
                toUrl(model);

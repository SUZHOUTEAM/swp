...
<script>
    /*公众号支付*/
    function gzhPay() {
        var url = "http://www.yifeiwang.com/swp/weixin/gzhPay.htm?total_fee=100&out_trade_no=12312314343234"; //注意此处的basePath是没有端口号的域名地址。如果包含:80,在提交给微信时有可能会提示 “redirect_uri参数错误” 。
        //money为订单需要支付的金额
        //state中存放的为商品订单号
        console.log(url);
        var weixinUrl = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx1f7da8ce41f7ac3e&redirect_uri=" + encodeURI(url) + "&response_type=code&scope=snsapi_userinfo&state=state#wechat_redirect";

            ...
            var vue=new Vue({
                ...
                methods: {
                    ...
                    entDetail:function (entId,facilitatorEntId) {
                        ...
                        window.location='<%=appPath%>/myenterprise/viewEnterpriseDetail.htm?ticketId=<%=ticketId%>&onlyViewFlg=true&enterpriseId='+entId+'&breadcrumbName=我的订单'+facilitatorEntId;
                    },
                    ...
                    contact:function (entId,releaseEntName) {
                        getEnterpriseContacts(entId,releaseEntName,'处置单位我的订单');
                    },

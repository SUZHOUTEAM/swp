...
var nativeShare = function (elementNode, config) {
    ...
    this.init = function () {
        ...
        this.isloadqqApi();
        // alert(UA);
        window.platform=platform_os;
        if(isWeixin){
            window.browserType=3;
        }else if(UA.indexOf('DingTalk')>-1){
            window.browserType=4;
        }else if(isqqBrowser || isucBrowser){
            window.browserType=2;
        }else{
            window.browserType=1;
        }
    };
    this.init();
    ...
    /*var nativeShare=document.getElementById('share');

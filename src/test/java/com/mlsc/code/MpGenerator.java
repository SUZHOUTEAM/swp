...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 包配置
        String moduleName = "yifeiwang";
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.mlsc");
        pc.setEntity("entity");
        ...
        dsc.setPassword("sckj8888");
        dsc.setUrl("jdbc:mysql://192.168.252.130:3209/yifei_db?characterEncoding=utf8");
...
//        strategy.setTablePrefix(new String[] { "yunxin_" });// 此处可以修改为您的表前缀
        ...
        strategy.setInclude(new String[]{"user_extended"}); // 需要生成的表
...
//        mpg.setCfg(cfg);
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return "D://projects//易废网//易废网//solid_waste//src//main//resources//mybatis//waste" + tableInfo.getEntityName() + ".xml";
            }
        });
        cfg.setFileOutConfigList(focList);
        mpg.setCfg(cfg);

 ...
 * Generated at: 2018-08-31 01:22:32 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsp.Inquiry;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    String ticketId = (String) request.getAttribute("ticketId");
      ...
      out.write('\r');
      out.write('\n');
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/common/webCommon/user_top.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("title", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("我的报价", request.getCharacterEncoding()), out, true);
      out.write('\r');
      out.write('\n');
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "/common/webCommon/wasteCircleMenu.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("menuId", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("#myShoppingCart", request.getCharacterEncoding()), out, true);
      out.write("\r\n");
      ...
      out.write("<link rel=\"stylesheet\" href=\"");
      out.print(appPath);
      out.write("/css/enterprise/qualification.css\">\r\n");
      out.write("<section>\r\n");
      ...
      out.write("        </span>\r\n");
      out.write("        <span class=\"el-breadcrumb__item\">\r\n");
      out.write("            <span class=\"el-breadcrumb__item__inner\">我的报价</span>\r\n");
      out.write("            <span class=\"el-breadcrumb__separator\">/</span>\r\n");
      out.write("        </span>\r\n");
      out.write("    </div>\r\n");
      out.write("    <div class=\"\">\r\n");
      ...
      out.write("                        <b>询价状态：</b>\r\n");
      out.write("                        <el-button type=\"text\" :class=\"{'select':inquiryStatus==''}\" @click=\"queryStatus('')\">全部</el-button>\r\n");
      out.write("                        <el-button type=\"text\" :class=\"{'select':inquiryStatus=='SUBMIT'}\" @click=\"queryStatus('SUBMIT')\">待确认</el-button>\r\n");
      out.write("                        <el-button type=\"text\" :class=\"{'select':inquiryStatus=='ACCEPT'}\" @click=\"queryStatus('ACCEPT')\">已成交</el-button>\r\n");
      out.write("                        <el-button type=\"text\" :class=\"{'select':inquiryStatus=='REFUSED'}\" @click=\"queryStatus('REFUSED')\">已谢绝</el-button>\r\n");
      out.write("                    </el-col>\r\n");
      ...
      out.write("                </el-row>\r\n");
      out.write("                <el-row :gutter=\"10\" class=\"searchDiv\">\r\n");
      out.write("                    <el-col :span=\"12\" align=\"left\">\r\n");
      out.write("                        <b>来&nbsp;&nbsp;源：</b>\r\n");
      ...
      out.write("                        <b>优先级：</b>\r\n");
      out.write("                        <el-button type=\"text\" :class=\"{'select':priority==''}\" @click=\"queryPriority('')\">全部</el-button>\r\n");
      out.write("                        <el-button type=\"text\" :class=\"{'select':priority=='URGENT'}\" @click=\"queryPriority('URGENT')\">紧急</el-button>\r\n");
      out.write("                        <el-button type=\"text\" :class=\"{'select':priority=='HIGH'}\" @click=\"queryPriority('HIGH')\">高</el-button>\r\n");
      out.write("                        <el-button type=\"text\" :class=\"{'select':priority=='GENERAL'}\" @click=\"queryPriority('GENERAL')\">一般</el-button>\r\n");
      out.write("                        <el-button type=\"text\" :class=\"{'select':priority=='NONE'}\" @click=\"queryPriority('NONE')\">暂不处理</el-button>\r\n");
      out.write("                    </el-col>\r\n");
      out.write("                </el-row>\r\n");
      out.write("                <div class=\"buy_item panel panel-body\" v-for=\"(item,index) in list\">\r\n");
      out.write("                    <el-row :gutter=\"10\" style=\"margin-bottom:10px\">\r\n");
      out.write("                        <el-col :xs=\"18\" :sm=\"18\" :md=\"18\" :lg=\"18\">\r\n");
      out.write("                            <span class=\"status\" :class=\"statusClass[item.busiStatus]\">{{item.busiStatus}}</span><b style=\"margin-left: 14px\">单位：</b><a href=\"javascript:\" title=\"查看企业详情\" @click=\"entDetail(item.releaseEntId,item.facilitatorEntId)\"><em style=\"margin-right: 4px\">{{item.releaseEnterName}}</em></a>\r\n");
      out.write("                            <a class=\"qipao_logo\" href=\"javascript:\" @click=\"contact(item.facilitatorEntId||item.releaseEntId,item.releaseEnterName)\" title=\"联系TA\" style=\"margin-right: 14px;\">\r\n");
      ...
      out.write("                            </b>\r\n");
      out.write("                            </em>\r\n");
      out.write("                            <span v-if=\"item.dispositionName\"   >\r\n");
      out.write("                                <b> 处置企业：</b>\r\n");
      out.write("                               <em>\r\n");
      out.write("                                   <b style=\"color: #1171d1\">\r\n");
      out.write("                                    {{item.dispositionName}}\r\n");
      out.write("                                    </b>\r\n");
      out.write("                               </em>\r\n");
      out.write("                            </span>\r\n");
      out.write("\r\n");
      ...
      out.write("                                {{item.inquiryDate}}\r\n");
      out.write("                        </el-col>\r\n");
      out.write("                    </el-row>\r\n");
      out.write("                    <el-row :gutter=\"10\" style=\"margin-bottom:10px\">\r\n");
      out.write("                        <el-col :xs=\"24\" :sm=\"24\" :md=\"24\" :lg=\"24\">\r\n");
      out.write("                            <b>报价方式：</b><em>{{item.quotedType==0?'打包报价':'单独报价'}}</em><b>金额：</b><em><b style=\"color: #ff474c;font-weight:bold\">￥{{item.totalPriceStr}}</b></em>\r\n");
      out.write("                            <b>总数：</b><em><b style=\"color: #1171d1\">{{getQualityTextBySelection(item.inquiryDetail)}}</b></em>\r\n");
      out.write("                            <b>优先级：</b>\r\n");
      out.write("                            <em>\r\n");
      out.write("                                <span v-show=\"!item.showPriorityEdit\">{{item.priority||'--'}}</span>\r\n");
      out.write("                                <el-button type=\"text\" style=\"color: #1171d1\" v-show=\"!item.showPriorityEdit\" @click=\"showPriorityEdit(index)\" style=\"margin-left:6px;\">设置</el-button>\r\n");
      out.write("                                <el-select v-model=\"item.priority\" v-show=\"item.showPriorityEdit\" placeholder=\"选择优先级\" style=\"width: 120px\" @change=\"editpriority(item,index)\">\r\n");
      out.write("                                    <el-option v-for=\"(key,value) in priorityList\" :key=\"value\" :label=\"key\" :value=\"value\">\r\n");
      out.write("                                    </el-option>\r\n");
      out.write("                                </el-select>\r\n");
      out.write("                            </em>\r\n");
      out.write("                            <span v-if=\"item.releaseUserPhoneNum\"   >\r\n");
      out.write("                                <b> 联系电话：</b>\r\n");
      out.write("                               <em>\r\n");
      out.write("                                   <b style=\"color: #1171d1\">\r\n");
      out.write("                                    {{item.releaseUserPhoneNum}}\r\n");
      out.write("                                    </b>\r\n");
      out.write("                               </em>\r\n");
      out.write("                            </span>\r\n");
      out.write("                        </el-col>\r\n");
      ...
      out.write("                        </tr>\r\n");
      out.write("                        <tr v-if=\"item.systemInquiryList&&item.systemInquiryList.length>0\" v-for=\"(item1,index1) in item.systemInquiryList\">\r\n");
      out.write("                            <td  class=\"is-center\">\r\n");
      out.write("                                {{index1+1}}\r\n");
      out.write("                            </td>\r\n");
      out.write("                            <td>\r\n");
      out.write("                                {{item1.wasteName}}\r\n");
      out.write("                            </td>\r\n");
      out.write("                            <td>\r\n");
      out.write("                                {{item1.wasteCode}}\r\n");
      out.write("                            </td>\r\n");
      out.write("                            <td class=\"is-right\">\r\n");
      out.write("                                {{parseFloat(item1.amount)+item1.unitValue}}\r\n");
      out.write("                            </td>\r\n");
      out.write("                            <td v-if=\"item1.first\" :rowspan=\"item.priceIdCountObj[item1.priceId]\" class=\"is-center\">\r\n");
      out.write("                                {{item1.dispositionType}}\r\n");
      out.write("                            </td>\r\n");
      out.write("                            <td v-if=\"item1.first\" class=\"is-right\" :rowspan=\"item.priceIdCountObj[item1.priceId]\">\r\n");
      out.write("                                <span style=\"color: #ff0000;\">￥{{item1.price}}{{['吨','千克','克'].indexOf(item1.unitValue)>-1?'/吨':''}}</span>\r\n");
      out.write("                            </td>\r\n");
      out.write("                            <td v-if=\"item1.first\" class=\"is-right\" :rowspan=\"item.priceIdCountObj[item1.priceId]\">\r\n");
      out.write("                                <span style=\"color: #ff0000;\">￥{{item1.wasteTotalPrice}}</span>\r\n");
      out.write("                            </td>\r\n");
      out.write("                            <td v-if=\"item1.first\" class=\"is-center\" :rowspan=\"item.priceIdCountObj[item1.priceId]\">\r\n");
      out.write("                                <el-tooltip effect=\"dark\" v-if=\"item1.remark\" :content=\"item1.remark\" placement=\"top-start\">\r\n");
      ...
      out.write("                        <el-button type=\"primary\" class=\"over\" @click=\"delInquiry(item)\"  v-show=\"item.busiStatus=='待确认'\">撤销报价</el-button>\r\n");
      out.write("                        <el-button type=\"primary\" class=\"over\" @click=\"requote(item)\"  v-if=\"item.busiStatus=='已谢绝'\">重新报价</el-button>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      ...
      out.write("                        <p><em>单位：</em><b>{{signItem.releaseEnterName}}</b></p>\r\n");
      out.write("                        <p><em>总数：</em><b><font color=\"#1171d1\">{{signItem.totalAmount}}</font></b></p>\r\n");
      out.write("                        <p><em>价格：</em><b><font color=\"#ff474c\">￥{{signItem.totalPriceStr}}</font></b></p>\r\n");
      out.write("                    </div>\r\n");
      ...
      out.write("                    priorityList:priorityList,\r\n");
      out.write("                    priority:'',\r\n");
      ...
      out.write("                            inquiryStatus:this.inquiryStatus,\r\n");
      ...
      out.write("                            priority:this.priority\r\n");
      out.write("                        };\r\n");
      out.write("                        ajax({\r\n");
      out.write("                            url: '/entInquiry/listEntInquiry.htm',\r\n");
      ...
      out.write("                                if (result.status == 1) {\r\n");
      out.write("                                    _this.list=result.data.inquiryList;\r\n");
      out.write("                                    for(var i in result.data.inquiryList){\r\n");
      out.write("                                        var item=result.data.inquiryList[i];\r\n");
      out.write("                                        if(localStorage.entType=='DIS_FACILITATOR'){\r\n");
      out.write("                                            item.dispositionName = item.inquiryEnterName.split('-')[0];\r\n");
      out.write("                                        }\r\n");
      out.write("                                        if(item['inquiryType']=='REFERENCE_PRICE'){\r\n");
      out.write("                                            var inquiryDetail=item.inquiryDetail;\r\n");
      ...
      out.write("                                                var o=inquiryDetail[j];\r\n");
      out.write("                                                if(!obj[o.priceId]){\r\n");
      out.write("                                                    o.first=true;\r\n");
      out.write("                                                    obj[o.priceId]=1;\r\n");
      out.write("                                                }else{\r\n");
      out.write("                                                    obj[o.priceId]+=1;\r\n");
      out.write("                                                }\r\n");
      out.write("                                            }\r\n");
      out.write("                                            item.priceIdCountObj=obj;\r\n");
      out.write("                                            item.systemInquiryList=inquiryDetail;\r\n");
      out.write("                                        }\r\n");
      out.write("                                    }\r\n");
      ...
      out.write("                        var _this=this;\r\n");
      out.write("                        ajax({\r\n");
      out.write("                            url:'/wasteActivity/listActiviyNameByInquiryEntId',\r\n");
      out.write("                            dataType: 'json',\r\n");
      ...
      out.print(ticketId);
      out.write("&onlyViewFlg=true&enterpriseId='+entId+'&breadcrumbName=我的询价'+facilitatorEntId;\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                        this.search();\r\n");
      out.write("                    },\r\n");
      out.write("                    queryPriority:function (status) {\r\n");
      out.write("                        this.priority=status;\r\n");
      out.write("                        this.search();\r\n");
      out.write("                    },\r\n");
      out.write("                    showPriorityEdit:function (index) {\r\n");
      out.write("                        var item=this.list[index];\r\n");
      out.write("                        item.showPriorityEdit=true;\r\n");
      out.write("                        Vue.set(this.list,index,item);\r\n");
      out.write("                    },\r\n");
      out.write("                    editpriority:function (item,index) {\r\n");
      out.write("                        ajax({\r\n");
      out.write("                            url:'/entInquiry/updateEntInquiryPriority.htm',\r\n");
      out.write("                            data:{\r\n");
      out.write("                                inquiryId:item.inquiryId,\r\n");
      out.write("                                priority:item.priority\r\n");
      out.write("                            },\r\n");
      out.write("                            success:function (result) {\r\n");
      out.write("                                if(result.status==1&&result.data){\r\n");
      out.write("                                    $.notify('分配成功',{status:'success',timeout:2500});\r\n");
      out.write("                                    item.priority=vue.priorityList[item.priority];\r\n");
      out.write("                                    item.showPriorityEdit=false;\r\n");
      out.write("                                    Vue.set(vue.list,index,item);\r\n");
      out.write("                                }\r\n");
      out.write("                            }\r\n");
      out.write("                        });\r\n");
      out.write("                    },\r\n");
      out.write("                    contact:function (entId,releaseEnterName) {\r\n");
      out.write("                        getEnterpriseContacts(entId,releaseEnterName,'处置单位我的报价');\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                        this.getList()\r\n");
      out.write("                    },\r\n");
      out.write("                    requote:function (item) {\r\n");
      out.write("                        var src = appPath + '/entRelease/cfBuy.htm?ticketId=");
      out.print(ticketId);
      out.write("&releaseId=' + item.releaseId + \"&breadcrumbName=我的报价\";\r\n");
      out.write("                        window.location = src;\r\n");
      out.write("                    },\r\n");
      out.write("                    delInquiry:function (item) {\r\n");
      out.write("                        var inquiryId=item.inquiryId;\r\n");
      out.write("                        var releaseId=item.releaseId;\r\n");
      out.write("                        vue.$confirm('此操作将撤销该报价, 是否确定?', '提示', {\r\n");
      out.write("                            confirmButtonText: '确定',\r\n");
      out.write("                            cancelButtonText: '取消',\r\n");
      out.write("                            type: 'warning'\r\n");
      out.write("                        }).then(function(){\r\n");
      out.write("                            ajax({\r\n");
      out.write("                                url:'/entInquiry/deleteEntInquiry',\r\n");
      out.write("                                data:{\r\n");
      ...
      out.write("                                        $.notify('撤销报价成功',{status:'success',timeout:2500});\r\n");

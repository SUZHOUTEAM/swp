 ...
 * Generated at: 2018-09-11 05:29:53 UTC
...
public final class cfList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    String ticketId = (String) request.getAttribute("ticketId");
      ...
      out.write("                        <a href=\"javascript:\" v-for=\"(item,index) in provinces\" :data-key=\"item.key\"\n");
      out.write("                           :class=\"province==item.key?'provinceItem select':'provinceItem'\"\n");
      out.write("                           @click=\"selectProvince(item.key,item.value)\">\n");
      ...
      out.write("                        <a href=\"javascript:\" v-for=\"(value,key) in cityList\" :data-key=\"key\"\n");
      out.write("                           @click=\"selectCity(key,value)\" :class=\"city==key?'select':''\">\n");
      out.write("                            {{value}}\n");
      out.write("                        </a>\n");
      out.write("                    </dd>\n");
      out.write("                </dl>\n");
      ...
      out.write("                        <a href=\"javascript:\" v-for=\"(value,key) in districts\" :data-key=\"key\"\n");
      out.write("                           @click=\"selectDistrict(key,value)\" :class=\"district==key?'select':''\">\n");
      out.write("                            {{value}}\n");
      out.write("                        </a>\n");
      out.write("                    </dd>\n");
      out.write("                </dl>\n");
      ...
      out.write("                    <dt>收藏：</dt>\n");
      out.write("                    <dd>\n");
      out.write("                        <a href=\"javascript:\" :class=\"{'select':favoriteType==false}\"\n");
      out.write("                           @click=\"selectFavorite(false)\">不限</a>\n");
      ...
      out.write("                    <span>{{moreShow?'收起':'更多筛选'}}<i\n");
      out.write("                            :class=\"moreShow?'el-icon-arrow-up':'el-icon-arrow-down'\"></i></span>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("            <div id=\"selected\" class=\"bar\" style=\"display: block;\"\n");
      out.write("                 v-show=\"provinceName||qualityType!=0||JSON.stringify(wasteCode) !== '{}'\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<em>含：(</em>\n");
      out.write("\t\t\t\t\t\t\t\t<span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"par\" v-for=\"(value,key) in wasteCode\"\n");
      out.write("                                          v-if=\"typeof value=='number'||typeof value=='string'\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<em>{{key}}</em>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<a href=\"javascript:\" @click=\"selectWaste(wasteInfoList[value],value)\"><i\n");
      out.write("                                                class=\"el-icon-close\"></i></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t<span v-else>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span class=\"par\" v-for=\"(item,index) in value\" v-if=\"item.select\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<em>{{item.code}}</em>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a href=\"javascript:\" @click=\"clearEightCode(item)\"><i\n");
      out.write("                                                    class=\"el-icon-close\"></i></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t\t\t\t\t</span>\n");
      ...
      out.write("                this.checkEntInfoCompleted();\n");

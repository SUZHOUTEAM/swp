 ...
 * Generated at: 2018-09-11 05:47:39 UTC
...
public final class cfList_005ffacilitator_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String ticketId = (String)request.getAttribute("ticketId");
      ...
      out.write("<link rel=\"stylesheet\" href=\"");
      out.print(appPath);
      out.write("/main/pc/css/money-dialog.css?2\">\n");
      ...
      out.write("\t\t\t\t\t<!-- 租金 -->\n");
      out.write("\t\t\t\t\t<dl class=\"filter_item\" id=\"provice_select\">\n");
      out.write("\t\t\t\t\t\t<dt>区域：</dt>\n");
      out.write("\t\t\t\t\t\t<dd>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:\" @click=\"selectProvince('','')\" :class=\"province==''?'select':''\">不限</a>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:\" v-for=\"(item,index) in provinces\" :data-key=\"item.key\" :class=\"province==item.key?'provinceItem select':'provinceItem'\" @click=\"selectProvince(item.key,item.value)\">\n");
      out.write("\t\t\t\t\t\t\t\t{{item.value}}\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:\" class=\"select\" @click=\"changeAllProvincesShow\">{{allProvincesShow?'&lt;收起':'展开全部&gt;'}}</a>\n");
      out.write("\t\t\t\t\t\t</dd>\n");
      out.write("\t\t\t\t\t</dl>\n");
      out.write("\t\t\t\t\t<dl class=\"filter_item\" id=\"city_select\" v-show=\"cityClick&&cityList\">\n");
      out.write("\t\t\t\t\t\t<dt>&nbsp;</dt>\n");
      out.write("\t\t\t\t\t\t<dd>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:\" :class=\"city==''?'select':''\" @click=\"selectCity('','')\">不限</a>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:\" v-for=\"(value,key) in cityList\" :data-key=\"key\" @click=\"selectCity(key,value)\" :class=\"city==key?'select':''\">\n");
      out.write("\t\t\t\t\t\t\t\t{{value}}\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t</dd>\n");
      out.write("\t\t\t\t\t</dl>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<dl class=\"filter_item\" id=\"district_select\" v-show=\"districts\">\n");
      out.write("\t\t\t\t\t\t<dt>&nbsp;</dt>\n");
      out.write("\t\t\t\t\t\t<dd>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:\" :class=\"district==''?'select':''\" @click=\"selectDistrict('','')\">不限</a>\n");
      out.write("\t\t\t\t\t\t\t<a href=\"javascript:\" v-for=\"(value,key) in districts\" :data-key=\"key\" @click=\"selectDistrict(key,value)\" :class=\"district==key?'select':''\">\n");
      out.write("\t\t\t\t\t\t\t\t{{value}}\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\t</dd>\n");
      out.write("\t\t\t\t\t</dl>\n");
      ...
      out.write("\t\t\t\t\t</dl>\n");
      out.write("\t\t\t\t\t<!-- 方式 -->\n");
      out.write("\t\t\t\t\t<dl class=\"filter_item\" id=\"wasteCode_select\" v-show=\"moreShow\">\n");
      out.write("\t\t\t\t\t\t<dt>代码：</dt>\n");
      out.write("\t\t\t\t\t\t<dd>\n");
      ...
      out.write("\t\t\t\t\t");
      out.write("\n");
      out.write("\t\t\t\t\t<dl class=\"filter_item\" id=\"eightCode_select\" v-show=\"eightCodeList.length>0&&moreShow\">\n");
      out.write("\t\t\t\t\t\t<dt>&nbsp;</dt>\n");
      out.write("\t\t\t\t\t\t<dd>\n");
      ...
      out.write("\t\t\t\t\t\t</dd>\n");
      out.write("\t\t\t\t\t</dl>\n");
      out.write("                    <dl class=\"filter_item\" id=\"favorite_select\" v-show=\"moreShow\">\n");
      out.write("                        <dt>收藏：</dt>\n");
      out.write("                        <dd>\n");
      ...
      out.write("                        </dd>\n");
      out.write("                    </dl>\n");
      out.write("                    <dl class=\"filter_item\" v-show=\"moreShow\">\n");
      out.write("                        <dt>权利：</dt>\n");
      out.write("                        <dd>\n");
      out.write("                            <a href=\"javascript:\" :class=\"{'select':binding==0}\" @click=\"selectBinding(0)\">不限</a>\n");
      out.write("                            <a href=\"javascript:\" :class=\"{'select':binding==1}\" @click=\"selectBinding(1)\">已购买</a>\n");
      out.write("                            <a href=\"javascript:\" :class=\"{'select':binding==2}\" @click=\"selectBinding(2)\">未购买</a>\n");
      out.write("                        </dd>\n");
      out.write("                    </dl>\n");
      out.write("\t\t\t\t\t<div class=\"moreBtn\" @click=\"moreShow=!moreShow\">\n");
      out.write("\t\t\t\t\t\t<em class=\"bor1\"></em>\n");
      out.write("\t\t\t\t\t\t<em class=\"bor2\"></em>\n");
      out.write("\t\t\t\t\t\t<span>{{moreShow?'收起':'更多筛选'}}<i :class=\"moreShow?'el-icon-arrow-up':'el-icon-arrow-down'\"></i></span>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"item_name\"><span @click=\"entDetail(item.isPay,item.releaseId,index)\">{{item.entName}}</span></span>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<p class=\"total_amount\"> 总计：<span> {{item.totalWasteCount}} </span> 种危废，累计<span>{{item.totalWasteAmountDesc}}</span>。</p>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</el-button>\n");
      out.write("\t\t\t\t\t\t\t\t\t<el-button type=\"text\" class=\"qipao_logo\" href=\"javascript:\" v-if=\"item.facilitatorEntId\" @click=\"contact(item.facilitatorEntId,item.entName,item.isPay,item.releaseId,index)\" style=\"margin-right: 18px;margin-left: 18px\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src=\"../main/pc/img/qipao.jpg\">联系TA</el-button>\n");
      out.write("\t\t\t\t\t\t\t\t\t<el-button type=\"text\" class=\"qipao_logo\" href=\"javascript:\" v-else @click=\"contact(item.releaseEntId,item.entName,item.isPay,item.releaseId,index)\" style=\"margin-right: 18px;margin-left: 18px\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src=\"../main/pc/img/qipao.jpg\">联系TA</el-button>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</el-button>\n");
      out.write("\t\t\t\t\t\t\t\t\t<el-button type=\"text\" href=\"javascript:\" class=\"goDetail\" v-show=\"item.disposalWasteCount && item.inquiryStatus=='0' \" @click=\"buy(item,index)\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<i class=\"responsepublish\"></i>报价</el-button>\n");
      out.write("\t\t\t\t\t\t\t\t\t<el-button type=\"text\" href=\"javascript:\" class=\"goDetail grey\" v-show=\"!item.disposalWasteCount \">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<i class=\"responsepublish\"></i>报价</el-button>\n");
      out.write("\t\t\t\t\t\t\t\t</el-row>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<el-button class=\"confirm-btn\" v-if=\"myBitAmount>=8&&!paySuccess\" @click=\"confirmPay()\">确定支付</el-button>\n");
      out.write("\t\t\t\t\t\t\t<el-button class=\"confirm-btn\" v-if=\"myBitAmount<8&&!paySuccess\" @click=\"recharge()\">立即充值</el-button>\n");
      ...
      out.write("\t\t\t\t\t\tcenter>\n");
      out.write("\t\t\t\t\t<div class=\"free-bit-bg facilitator\">\n");
      ...
      out.write("\t\t\t\t\t\t:visible.sync=\"noCompany\"\n");
      out.write("\t\t\t\t\t\tcenter>\n");
      out.write("\t\t\t\t\t<img src=\"");
      out.print(appPath);
      out.write("/main/pc/img/noCompany.png\" class=\"noCompany-img\"/>\n");
      out.write("\t\t\t\t\t<div class=\"no-company-bg\">\n");
      out.write("\t\t\t\t\t\t<div class=\"noCompany-text\">您还未登记所代理的处置企业，请立即登记，登记后进行报价</div>\n");
      out.write("\t\t\t\t\t\t<a href=\"javascript:\" class=\"noCompany-btn\" @click=\"goAddCustomer\">立即登记</a>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</el-dialog>\n");
      out.write("\t\t\t</template>\n");
      out.write("\t\t</div>\n");
      ...
      out.write("\t\t\t\t\tnoCompany:false,\n");
      out.write("\t\t\t\t\tcityClick:false\n");
      out.write("                },\n");
      out.write("                created:function() {\n");
      out.write("                    var currentCantonCode = localStorage.province+\"0000\";\n");
      out.write("\n");
      out.write("                    this.selectProvince(currentCantonCode,ChineseDistricts['provinces'][currentCantonCode]);\n");
      out.write("//                    this.getList();\n");
      out.write("                    this.checkHasCompany();\n");
      out.write("                    this.checkBitcionAccountExist();\n");
      out.write("                    var arr1=[],arr2=[];\n");
      out.write("                    for(var key in this.provinces){\n");
      out.write("                        if(key=='320000'){\n");
      out.write("                            arr1.unshift({\n");
      out.write("                                key:key,\n");
      out.write("                                value:this.provinces[key]\n");
      out.write("                            });\n");
      out.write("\t\t\t\t\t\t}else if (key == '350000') {\n");
      out.write("                            arr1.push({\n");
      out.write("                                key: key,\n");
      out.write("                                value: this.provinces[key]\n");
      out.write("                            });\n");
      out.write("                        }else if(key=='130000'){\n");
      out.write("                            arr1.push({\n");
      out.write("                                key:key,\n");
      out.write("                                value:this.provinces[key]\n");
      out.write("                            });\n");
      ...
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t\tthis.provinces=arr1.concat(arr2);\n");
      out.write("                },\n");
      ...
      out.write("                        });\n");
      out.write("                    },\n");
      out.write("                    goAddCustomer:function () {\n");
      ...
      out.print(ticketId);
      out.write("','PC_PAY_CONTRACT',entName);\n");
      out.write("                                getEnterpriseContacts(entId,entName,'资源池');\n");
      out.write("                            };\n");
      ...
      out.write("\t\t\t\t\t\t}\n");
      out.write("                    },\n");
      out.write("                    checkHasCompany:function () {\n");
      out.write("                        ajax({\n");
      ...
      out.write("                                console.log(result);\n");
      out.write("                                if(result.status==1){\n");
      out.write("                                    if(!result.data.customerList||result.data.customerList.length==0){\n");
      out.write("                                        vue.noCompany=true;\n");
      out.write("                                    }\n");
      out.write("                                }\n");
      out.write("                            }\n");
      out.write("                        });\n");
      ...
      out.write("                                                var releaseId=item.releaseId;\n");
      out.write("                                                var facilitatorEntIdStr=item.facilitatorEntId?('&facilitatorEntId='+item.facilitatorEntId):'';\n");
      out.write("                                                var src=appPath+'/entRelease/cfBuy_facilitator.htm?ticketId='+getParam('ticketId')+'&releaseId='+releaseId+\"&breadcrumbName=资源池\"+facilitatorEntIdStr;\n");
      out.write("                                                window.location=src;\n");
      out.write("                                            }\n");
      out.write("                                        }\n");
      out.write("                                    }\n");
      ...
      out.write("                                    vue.entDialogVisible=!data.data.isAllCompleted;\n");

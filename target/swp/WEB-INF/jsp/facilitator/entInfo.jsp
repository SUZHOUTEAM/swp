                    ...
                    <div class="media-box-body box1">
                        ...
                        <div class="col-md-9 colcss">
                            <strong class="media-box-heading text-primary">
                                ...
                                <span class="enterprise-type-badge marginSpanEnterpriseType facilitator-badge">服务商</span>
                            </strong>
                            <p class="mb-sm">
                                <span>企业代码：${sysEnterpriseBase.entCode}</span>
                            </p>
                            <c:if test="${sysEnterpriseBase.enterpriseStatus eq 'SUBMIT'}">
                            <p class="mb-sm">
                            ...
                            <c:if test="${sysEnterpriseBase.enterpriseStatus eq 'SUBMIT'}">
                            <p class="mb-sm">
                                <span>加入时间：${sysEnterpriseBase.createTime}</span>
                            </p>
                            </c:if>
            ...
            <div class="panel-body">
                <ul id="myTab" class="nav nav-tabs">
                    ...
                    <c:if test="${sysEnterpriseBase.enterpriseStatus eq 'PASS'}">
                        ...
                        <%--<li>
                            <a href="javascript:;" onclick="enterpriseEvaluation(this)">企业评价</a>
                        </li>--%>
                    </c:if>
                </ul>
                <div id="myTabContent" class="tab-content col-md-12">
                    ...
                    <div class="tab-pane fade" id="enterpriseEvaluationInfo">
                    </div>
                </div>
            </div>
        </div>
